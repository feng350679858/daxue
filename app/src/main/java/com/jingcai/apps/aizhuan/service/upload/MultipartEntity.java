...
public class MultipartEntity implements HttpEntity {
     ...
     * jpeg图片
     */
    private final String TYPE_IMAGE_JPEG = "image/JPEG";
    /**
     * 二进制参数
     */
     ...
     * @param rawData
     */
    public void addImagePart(String paramName, final byte[] rawData) {
        writeToOutputStream(paramName, rawData, TYPE_IMAGE_JPEG, BINARY_ENCODING, "no-file");
    }
