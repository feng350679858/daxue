package com.jingcai.apps.aizhuan.view.processbtn;
 ...
 */
public class ProcessButton extends FrameLayout implements View.OnClickListener {
    ...
    enum FrmwrkMode {
        INIT, READY, LODING, FINISH
    }

    public FrmwrkMode flg_frmwrk_mode = FrmwrkMode.INIT;
    ...
    private void setAnimation() {
        ...
        out.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                flg_frmwrk_mode = FrmwrkMode.LODING;
            }
        });

        new_scale_in.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                flg_frmwrk_mode = FrmwrkMode.FINISH;
                buttonimage.startAnimation(in);
    ...
    public void init() {
        ...
        flg_frmwrk_mode = FrmwrkMode.READY;
    ...
    public void animation() {
        ...
        if (first_click == false) {
            if (flg_frmwrk_mode == FrmwrkMode.READY) {
                first_click = true;
    ...
    public boolean isReady() {
        return flg_frmwrk_mode == FrmwrkMode.READY;
    }

    public boolean isLoading() {
        return flg_frmwrk_mode == FrmwrkMode.LODING;
    }

    public boolean isFinished() {
        return flg_frmwrk_mode == FrmwrkMode.FINISH;
    }

    public void setupprogress(int value) {
        cusview.setupprogress(value);
    }
}