...
public class MinePartjobWorkdayListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mIsCancel) {
            viewHolder.tv_workday.setCompoundDrawablesWithIntrinsicBounds(R.drawable.partjob_detail_popup_time, 0, R.drawable.mine_partjob_detail_workday_list_cancel, 0);
        } else {
            ...
            if (worktimeTimeMillis > System.currentTimeMillis()) {
                //开没到工作时间
                viewHolder.tv_workday.setCompoundDrawablesWithIntrinsicBounds(R.drawable.partjob_detail_popup_time, 0, R.drawable.mine_partjob_detail_workday_list_wait, 0);
            } else if (System.currentTimeMillis() > worktimeAfterDayTimeMillis) {
                //过了时间
                viewHolder.tv_workday.setCompoundDrawablesWithIntrinsicBounds(R.drawable.partjob_detail_popup_time, 0, R.drawable.mine_partjob_detail_workday_list_finish, 0);
            } else {
                viewHolder.tv_workday.setCompoundDrawablesWithIntrinsicBounds(R.drawable.partjob_detail_popup_time, 0, R.drawable.mine_partjob_detail_workday_list_working, 0);
            }
        }
        return convertView;
    }
