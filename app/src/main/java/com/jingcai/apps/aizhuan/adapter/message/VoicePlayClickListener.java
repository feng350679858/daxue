...
public class VoicePlayClickListener implements View.OnClickListener {
    ...
    public void stopPlayVoice() {
        ...
        isPlaying = false;
        ((MessageConversationActivity) activity).playMsgId = null;
    ...
    public void playVoice(String filePath) {
        ...
        ((MessageConversationActivity) activity).playMsgId = message.getMsgId();
...
//		}
        try {
            ...
            Log.e(TAG, "voice message play failed");
        }
    }
...
//		String st = activity.getResources().getString(R.string.Is_download_voice_click_later);
        String st = "等会哦~";
        if (isPlaying) {
            if (((MessageConversationActivity) activity).playMsgId != null && ((MessageConversationActivity) activity).playMsgId.equals(message.getMsgId())) {
